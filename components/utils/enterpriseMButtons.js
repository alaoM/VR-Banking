...
export const Enterprisem = ({ res, role_id,setInfo, BASE_URL}) => {
    console.log(res)
    console.log(role_id)
    ...
    const do_AdminConfirm = async (_id)=>{
        ...
        params: {
            regid: 'doAdminEnterprisemConfirm',
            _id:_id
        }
        },customConfig)
        console.log(resp)
    ...
    const do_ClusterConfirm = async (_id)=>{
        ...
        const resp=  await axios.get(BASE_URL+'/api.php',{
        params: {
            regid: 'doClusterValidateEnterprisem', 
            _id:_id 
        }
        },customConfig)
        console.log(resp)
    ...
    const do_GroupConfirm = async (_id)=>{
        ...
        const resp=  await axios.get(BASE_URL+'/api.php',{
        params: {
            regid: 'doGroupValidateEnterprisem',
            _id:_id
        }
        },customConfig)
        console.log(resp)
    ...
    const do_AreaConfirm = async (_id)=>{
        ...
        const resp=  await axios.get(BASE_URL+'/api.php',{
        params: {
            regid: 'doAreaValidateEnterprisem', 
            _id:_id 
        }
        },customConfig)
        console.log(resp)
    ...
    const do_MobileConfirm = async (_id)=>{
        ...
        const resp=  await axios.get(BASE_URL+'/api.php',{
        params: {
            regid: 'doMobileValidateEnterprisem', 
            _id:_id 
        }
        },customConfig)
        console.log(resp)
                            ...
                            role_id =='633' ? (
                              ...
                              role_id =='634' ? (
                                ...
                                Resp.status =='200' ? (
                                    ...
                                    res[0]['mobileMRC_confirm_status'] == "0" ?
